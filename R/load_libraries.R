...
#'
#' `load_libraries()` checks whether the package is already installed,
...
#'   whereas 'library' throws an error if it can't load the package. Hence `load_libraries()`
...
#' @export
#'
load_libraries <- function(..., repo = "https://cran.rstudio.com"){
