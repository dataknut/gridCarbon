...
nzGenMix_wide_dt[, dv_total := Coal + Diesel + Gas + Hydro + Solar + Wind + Wood]
...
we think renewable is wind + solar + hydro + geothermal - but note that geothermal is not necessarily low carbon
