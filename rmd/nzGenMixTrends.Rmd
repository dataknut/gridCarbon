 ...
 * Anderson, B, (`r lubridate::year(now())`) New Zealand generation share trends: Electricity Authority data. https://dataknut.github.io/gridCarbon/docs/nzGenMixTrends.html
...
Instead use a [model derived from the GB MWh generation mix for 2023](https://dataknut.github.io/gridCarbon/gbGenMixTrends.html#92_CI_model) (which may be way off but...)
...
This is (obviously) completely broken as HYDRO_perc has a +ve coefficient, it does not include a coefficient for Geothermal or Wood and the GB mix includes Nuclear, Interconnection and Storage. #YMMV
