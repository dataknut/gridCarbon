...
```{r carbonStripesCI, fig.cap="Maximum daily half-hourly carbon intensity"}
#plotDT <- gbGenMix_dt[, .()]
ci <- make_NgesoPlots(gbGenMix_dt, 
...
\@ref(fig:meanRenewablesVsMeanGen) shows the rise of solar...

```{r meanRenewablesVsMeanGen, fig.cap="Mean renewables by time of day"}
